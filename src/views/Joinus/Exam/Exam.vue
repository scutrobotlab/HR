<template>
  <div>
    ...
    <v-btn text to="/joinus/exam/main"> <v-icon left>mdi-arrow-left</v-icon>查看其他题库</v-btn>
    <v-card>
      <v-card-title>{{ $route.params.group }}面试题库</v-card-title>
      <v-card-subtitle>面试官只问你会的题目。</v-card-subtitle>
      <v-list>
      ...
      <v-card-title class="colorful"
        >您通过{{ $route.params.group }}面试的概率为{{ probability }}%。</v-card-title
      >
