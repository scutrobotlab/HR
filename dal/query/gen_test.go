...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		...
		qCtx.Remark.UnderlyingDB().Statement.Context,
		qCtx.Score.UnderlyingDB().Statement.Context,
		qCtx.Setting.UnderlyingDB().Statement.Context,
		qCtx.Standard.UnderlyingDB().Statement.Context,
	} {
